...
import {
  Form, Select, Modal, Input, notification,
} from 'antd'
...
const CollectionCreateForm = Form.create({ name: 'form_in_modal' })(
  ...
  class extends React.Component {
    ...
    render() {
      const {
        visible, onCancel, onOk, form, loading, projectList,
      } = this.props
...
class CodeUpload extends Component {
  ...
  constructor(props) {
    ...
    this.state = { ...CodeUpload.initialState }
  }
...
export default connect((state) => state, mapDispatchToProps, mergeProps, { forwardRef: true })(CodeUpload)
